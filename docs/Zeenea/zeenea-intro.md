...
description: Discover the intelligent Data Intelligence Platform that enables metadata management for search, exploration, data governance, compliance, and cloud transformation initiatives.
---
...
![Actian Platform Overview](./images/zeenea-platform.jpg)

## Key Features

### :material-link-variant: Universal connectivity
...
### :material-cloud: Cloud-native design
...
### :material-brain: Powered by knowledge graph technologies
...
### :material-shield-check: A safe & secure platform
...
<!--ARCADE EMBED START-->
<div style="position: relative; padding-bottom: calc(55.4398% + 41px); height: 0px; width: 100%;"><iframe src="https://demo.arcade.software/EaFxabXRFQiV5CiDdhpt?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" title="Find and explore data assets with guided search and catalogs" frameborder="0" loading="lazy" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="clipboard-write" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; color-scheme: light;" ></iframe></div>
<!--ARCADE EMBED END-->
...
![Actian Studio Interface](./images/zeenea-studio-intro.png)
...
![Actian Explorer Interface](./images/zeenea-explorer.png)

???+ info "Related information"
    - [Actian Explorer Overview](../Zeenea_Explorer/zeenea-explorer-overview.md)
    - [Actian Studio Overview](../Zeenea_Studio/zeenea-studio-overview.md)
    - [API Documentation](../APIs/intro.md)
