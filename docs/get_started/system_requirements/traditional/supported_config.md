...
A “supported configuration” is a combination of Actian Software and other dependent products (typically at a specified version, release, fix, or specification level) that has been validated by HCL.

Actian provides full support for configurations in this category. Support is provided under the terms of the product license to ensure that the product operates within its specifications.  

For more details, see [Actian DX support statement](../../../get_started/software_support.md).

## Operating systems

Actian Digital Experience (DX) V9.5 supports the following operating systems, which are organized by operating system family. Operating system families include AIX, Linux, and Windows.
...
Actian DX 9.5 supports the following hypervisors:
...
Actian DX 9.5 requires the following capabilities and products to provide those capabilities:
...
Actian DX 9.5 requires Java Development Kit (JDK) version 7.0* or later for installation.
...
\*Customers using JDK 7.0 with WAS 8.5.5 will only be able to use the out-of-the-box, default CKEditor provided with Actian DX.
...
|-----------|------------------|-----|
|Actian Connections|8.0 and later maintenance|9.5|
|Actian Leap|9.2 and later maintenance|9.5|

## Development tools

|Supported software|Supported software minimum|Product minimum|
|-----------|------------------|-----|
|Actian Web Experience Factory|8.5.1 and later maintenance releases|8.5|
...
|Actian Domino|9.0 and later maintenance releases|8.5|
...
Actian DX requires the following hardware, organized by type of hardware, deployment units or components.
...
|Other Hardware|Server|Minimum 2 CPUs required for installations of DX Portal and Actian WCM|All supported Linux operating systems|
...
|Other Hardware|Server|Minimum 2 CPUs required for installations of DX Portal and Actian WCM|All supported Windows operating systems|
