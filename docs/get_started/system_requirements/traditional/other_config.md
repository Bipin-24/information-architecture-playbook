...
Many configurations of Actian products and other software exist that are not explicitly listed as "supported configurations” or “unsupported configurations.” However, these products and software can reasonably be expected to perform within the accepted bounds of reliability, function, and performance.  
...
Before you decide to use the any dependent products in the following list, see [Actian DX support statement for other configurations](../../../get_started/software_support.md).


## Operating systems

The following sections specify the operating systems that Actian Digital Experience 9.5 supports and is organized by the operating system family. Operating system families include AIX, Linux, and Windows.
...
## Hypervisors
The hypervisors section specifies the hypervisors that Actian Digital Experience 9.5 supports.
...
This section specifies the capabilities that Actian Digital Experience 9.5 requires and the prerequisite products that provide those capabilities.
...
|-----------|------------------|-----|
|Actian Connections|5.5 and later maintenance|8.5|
|Actian Connections|6.0 and later maintenance|8.5|
|IBM Forms Experience Builder|8.6.3 and later maintenance|8.5|
|Actian Sametime Premium|11.5, 11.6, 12.0 and later maintenance|9.5|
...
|-----------|------------------|-----|
|Actian Domino|10.0 and later maintenance releases*|9.5|
