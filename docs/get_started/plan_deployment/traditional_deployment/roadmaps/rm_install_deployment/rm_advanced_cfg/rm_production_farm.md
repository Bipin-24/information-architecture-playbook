# Actian Digital Experience roadmap: Portal farm
...
2.  Get required software. New and current users must [sign up or register at Actian Software](https://www.actian.com/wps/portal/about/welcome) and download their preferred Actian Digital Experience package.
...
Installing Actian Digital Experience involves preparing your operating system, installing or upgrading the installation manager, and running the installation program. See [Installing the Actian Digital Experience software](../../../../../../deployment/install/traditional/installing_dx/index.md)

## Applying the latest cumulative fix

Maintain the portal by deploying individual Fixes and Combined Cumulative Fixes (CFs), which are suggested according to your environment. See [Actian Digital Experience roadmap: Applying maintenance](../rm_cf.md).
...
Log in to Actian Digital Experience to verify that the portal works:
...
If you are working with an Actian Digital Experience V8.5 or 9 software at a level earlier than CF18, the wizard address is http://your_server:10200/ibm/wizard. After installing CF18, the configuration wizard automatically changes to http://your_server:10200/hcl/wizard.
...
If the language is not currently supported for the user interface, you might see the English version. For details about supported languages and the language codes for all of the Actian Digital Experience user interfaces, see [Language support](../../../../../../deployment/manage/portal_admin_tools/language_support/index.md).
...
14. Log in to Actian Portal to verify that the portal server works.
...
2.  Check the tuning guide for more instructions. Use the tuning guide for the previous product version until the tuning guide for the current release is unavailable. See [Performance tuning guide](https://support.actian.com/csm?id=kb_article&sysparm_article=KB0074411).
...
Actian Digital Experience provides two distinct search capabilities. You can use both types of search capabilities in a portal farm environment.
