# Actian Digital Experience roadmap: Production and delivery environment

The production environment include the servers that provide incoming web traffic accesses to the web elements you build with Actian Digital Experience. This roadmap is based on a cluster topology.
...
Installing Actian Digital Experience involves preparing your operating system, installing or upgrading the installation manager, and running the installation program. See *Installing the Actian Digital Experience software* for more topic information.
...
2.  Access the Configuration wizard: http://your_server:10200/hcl/wizard.
    ...
    !!! note
        If you are working with Actian Digital Experience version 8.5 or 9 software at a level prior to CF18, the wizard address is http://your_server:10200/ibm/wizard. After you install CF18, the configuration wizard automatically is adjusted to http://your_server:10200/hcl/wizard.
...
If the language you work in is not currently supported for the user interface, you might see the English version. For details about supported languages and the language codes for all of the Actian Portal user interfaces, see [Language support](../../../../../../deployment/manage/portal_admin_tools/language_support/index.md).
...
9.  Log in to Actian Portal to verify that your portal server works.
...
15. If you changed the context root during the installation or configuration of Actian Digital Experience, then you must complete the optional next step from the Configuration wizard to update parameters with the new context path after you complete the Create a Deployment Manager configuration option.

16. Log in to Actian Portal to verify that your portal server works.
...
22. Log in to Actian Portal to verify that your portal server works.
...
28. Log in to Actian Portal to verify that your portal server works.

29. Complete the following steps to create extra cluster nodes:
30. Install Actian Digital Portal on an additional node.
...
35. Log in to Actian Portal to verify that your portal server works.
...
Tuning the servers is important to the performance of your portal environment. After installation and deployment, Actian Digital Experience is not tuned for a production environment. Your database requires tuning for improved performance. You can organize your database now or soon after you finish your configuration. You must tune and maintain your database on a regularly.
...
-   **Change the default portal Uniform Resource Identifier (URI)**
    ...
    Complete the context root change on the Configuration for Actian Portal: Profile configuration details: Advanced panel during installation. 
<!-- It's unclear what the explanatory text means. Two colons in a single construction aren't grammatical. "Complete the context root change on the ... Actian Portal" makes sense but not what comes after it. -->
