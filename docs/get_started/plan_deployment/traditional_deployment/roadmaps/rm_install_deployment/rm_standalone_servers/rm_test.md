...
2.  Get the software. New and existing users need to [sign up or register at Actian Software](https://www.actian.com/wps/portal/about/welcome) and download their preferred Actian Digital Experience package.
...
Installing Actian Portal involves preparing your operating system, installing or upgrading the installation manager, and running the installation program.

-   Documentation resource: [Installing the Actian Digital Experience software](../../../../../../deployment/install/traditional/installing_dx/index.md)
...
-   Documentation resource: [Actian Portal Roadmap: Applying maintenance](../../../roadmaps/rm_install_deployment/rm_cf.md)
...
3.  Log in to the Configuration Wizard with the administrative ID for the configuration wizard profile, cw\_profile.
    ...
    !!! note 
        If the language is not currently supported for the user interface, you might see the English version. For details on supported languages and the language codes for all of the Actian Digital Experience user interfaces, see [Supported languages](../../../../../../deployment/manage/portal_admin_tools/language_support/index.md).
...
9.  Log in to Actian Digital Experience to verify that you have a working portal server.
...
14. Log in to Actian Portal to verify that you have a working portal server.
...
2.  Check the tuning guide for more instructions. Use the tuning guide for the previous product version when the tuning guide for the current release is unavailable.
    ...
    -   Documentation resource: [Performance tuning guide](https://support.actian.com/csm?id=kb_article&sysparm_article=KB0074411)
...
-   **Change the default portal Uniform Resource Identifier (URI)**
    ...
    If you changed the context root on the Configuration for Actian Portal: Profile configuration details: Advanced panel during installation: [Completing the context root change started during installation](../../../../../../deployment/manage/siteurl_cfg/cfg_intr_inst.md)
