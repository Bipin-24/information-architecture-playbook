...
1. Install Actian Digital Experience.
...
Review the following considerations before you configure the (ODR) to route traffic to Actian Portal clusters:
...
-   The ODR can selectively route traffic to clusters based on the URL of the incoming traffic. You can configure IP alias values for the ODR. Then, you can define routing rules to associate user traffic for each IP alias to the appropriate Actian Portal cluster.
