...
This topic provides information when a failover happens and the failover support available for Actian Digital Experience (DX).
...
By default, failover support is available for Actian DX and any portlets that are installed with the product. To take advantage of failover support with your own developed portlets, you must ensure that your portlets are correctly implemented.
