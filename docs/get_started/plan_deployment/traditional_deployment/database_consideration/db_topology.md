...
Actian Portal data is separated into six portal database domains:
- Release
- Customization
- Community
- JCR
...
For typical load balancing, you can use one or more remote databases. You can install the database management software on a different server from Actian Portal. When the database is on a different physical server from the portal, it is referred to as a remote database. Using a remote database can provide performance benefits, depending on the speed of the network.
