# Actian Web Content Manager (WCM) environments
...
Each server or cluster in your web content system requires a separate data repository. However, they typically share LDAP. An Actian Web Content Manager system can be deployed in isolation or in parallel with an Actian Digital Experience system.
...
If you have only an Actian Web Content Manager license, you can deliver your website without by using Actian Digital Experience features.
