# Downloading and deploying Actian products from a Harbor Repository
...
The Actian Digital Experience (DX) 9.5 container images and Helm charts are available from the [Actian Harbor container repository](https://hclcr.io/){target="_blank"}. If you have credentials for the [My ActianSoftware (MHS) portal](https://my.actian.com/){target="blank"}, you can use them to access these DX 9.5 components.
...
| Actian DX Deployment version | Actian DX Search version | CF version |
| :------------------------ | :-------------------- | :--------- |
| 2.26.0                    |                       | CF217      |
| 2.27.0                    |                       | CF218      |
| 2.28.0                    |                       | CF219      |
