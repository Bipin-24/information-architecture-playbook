...
description: The Zeenea query language is a simple text-based query language for filtering data from the search bar. It can be used in the Studio and Explorer.
---
