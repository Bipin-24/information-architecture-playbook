...
description: Zeenea provides a **machine-to-machine** authentication mechanism based on API keys. This key must be generated from the administration interface o...
---
